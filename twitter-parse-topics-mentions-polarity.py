#Aku Hiltunen, Tampere University of Technology
...
#goest through the table one row at a time
...
output2 = "../twitterdata/mentions.csv"
output3 = "../twitterdata/hashtags.csv"
